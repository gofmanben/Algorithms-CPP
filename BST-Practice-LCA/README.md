## README for BinHeap/Tree section test: LCA function ##
...
It has many basic functions implemented. Your job is to implement the LCA function
...
lca <INT> <INT>: get the LCA of nodes containing the respective arguments. You can assume that the BST only stores distinct keys.
