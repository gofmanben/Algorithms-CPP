### HW1(Linked List) - File Structure
...
* shakespeare-cleaned.txt: This file has all of Shakespeare's text, somewhat cleaned up. Each line has a separate word, all in lowercase.
...
**Shakespeare_Instructions.md**: The file that explains the assignment.
