...
This assignment is on designing a fast data structure for range queries of words. 
The primary objective is to develop an understanding of Binary Search Trees and traversal (Part 1), as well as the role of balancing and augmentation in achieving efficient data structures (Part 2).

### Assignment details

Here are the relevant files and directories.

**range_BST_instructions.md**: Assignment description. Please read that first!

**Wordrange/**: This folder contains the files for your submission. You must write your code in this folder. Your Makefile
must be in this directory, and should create the executable **main** in this directory. Here is a description of files
