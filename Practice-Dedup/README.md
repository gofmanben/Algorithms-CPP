## README for LinkedList section test: dedup function ##
...
Your job is to implemented the dedup function, as described below. 
...
Makefile, linkedlist.cpp, linkedlist.h, listwrapper.cpp, simple-input-dedup.txt, simple-output-dedup.txt 
...
The files simple-input-dedup.txt, simple-output-dedup.txt are example input and output files. In a correct code, the output should exactly match this output.
...
If your code does not get simple-input-dedup.txt correct, you do not get any points.
