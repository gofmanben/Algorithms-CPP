## README for LinkedList section test: reverseTail function ##
...
Your job is to implemented the reverse tail function. 
...
Makefile, linkedlist.cpp, linkedlist.h, listwrapper.cpp, simple-input-reversetail.txt, simple-output-reversetail.txt 
...
The files simple-input-reversetail.txt, simple-output-reversetail.txt are example input and output files. In a correct code, the output should exactly match this output.
...
If your code does not get simple-input-reversetail.txt correct, you do not get any points.
...
revtail <INT>: reverse the last <INT> elements of the list, and keep the other elements in the same order
