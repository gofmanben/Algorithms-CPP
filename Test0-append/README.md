## README for practice section test: append-- add item to end of a LinkedList ##

Niloofar Montazeri, Jan 2025

### The append function ###

The folder LinkedList contains a standard implementation of a linked list, with a wrapper to run it.
Your job is to implemented the **append** function. 

**void append(int)**: Given a non-negative int argument (say, val), this function adds it to the end of the list. 
Suppose our list is 10 20 30 40. The function append(50) would lead to 10 20 30 40 50.


### Instructions ###

In the LinkedList directory, you will see the following files.
Makefile, linkedlist.cpp, linkedlist.h, main.cpp, simple-input-append.txt, simple-output-append.txt 
...
The files simple-input-append.txt, simple-output-append.txt are example input and output files. In a correct code, the output should exactly match this output.
...
If your code does not get simple-input-append.txt correct, you do not get any points.
...
ap <INT>: append <INT> to the end of the list
